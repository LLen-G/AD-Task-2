...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/battleSim.css">
    ...
    <div class="main">
        <div class="character-enemy-container">
            <div class="characters">
                <img src="../assets/img/Furina.png" alt="Furina" class="character">
                <img src="../assets/img/Skirk.png" alt="Skirk" class="character2">
            </div>
            <div class="game-text">
            ...
            <div class="enemy">
                <img src="../assets/img/ruinGuard.png" alt="Ruin Guard" class="enemy-img">
            </div>
        </div>
    </div>
</body>
